classdef ControlParams < handle
    ...
    methods
    function params = ControlParams(ex,ey,ez,n,P,H,type,dq_bounds,q,dq,pos,orien,pos_v,ang_v,...
            w_t,v_t,epsilon,view_port,axes_lim,inc_pos_v,inc_ang_v,stop,er,ep,upper_dq_bounds)
        if nargin > 0
            params.def.ex = ex;
            params.def.ey = ey;
            params.def.ez = ez;
